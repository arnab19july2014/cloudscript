...
export CLOUD_INIT_USERNAME=${CLOUD_INIT_USERNAME:-manoj}
export CLOUD_INIT_USE_SSHPUBKEY=${CLOUD_INIT_USE_SSHPUBKEY:-'ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBHKcDohm7pA/Zx+167mlZVbfVsMub1cPV8fOalb+apK+6RDB55GaBO+EOTVh8G+a32f5nFAQxQFjEycYweQE0/E= ecdsa-key-20230511'}
