...
export CLOUD_INIT_USERNAME=${CLOUD_INIT_USERNAME:-sujoy}
export CLOUD_INIT_USE_SSHPUBKEY=${CLOUD_INIT_USE_SSHPUBKEY:-'ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBJiWXgMbYfVjuzU9gshv80YYH34hPL34DGQejrT4eVJ0UesNuzYc88cbYENyjMGA7iNU93d428lVJBq+HQw/9mc= ecdsa-key-20230221'}
