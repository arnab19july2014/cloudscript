...
export CLOUD_INIT_USERNAME=${CLOUD_INIT_USERNAME:-tanu}
export CLOUD_INIT_USE_SSHPUBKEY=${CLOUD_INIT_USE_SSHPUBKEY:-'ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBJE/WjGM4bsFSgQCIW516dHLn6qNo5R+YP0SN6YF0It1EN4MKifzPQ7oI7oQtfW+0FgYpNH7rL41RPb82vmswdk= arnab@boenci.com'}
